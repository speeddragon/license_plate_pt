defmodule LicensePlatePT do
  ...
  * AA-00-AA
  ...
  @license_plate_without_hiffen_regex ~r/((?!AM|AP|CC|EM|MB|MC|ME|MF|MG|MH|MI|MJ|ML|MU|MV|MX|MZ|NU|NV|NZ|OU|OV|OZ|PR|PU|PV|PZ|QU|QV|QZ|RU|RV|RZ|SU|SV|SZ|TB|TC|TD|TE|TF|TG|TH|TJ|TL|TQ|TZ|UM|UN|UO|UP|UQ|UR|US|UT|UV|VM|VN|VO|VP|VQ|VR|VS|VT|ZA|ZC|ZD|ZG|ZH|ZI|ZJ|ZL|ZM|ZM|ZQ|ZT|ZU|ZV)[A-JL-VXZ][A-JL-VXZ](?!0000)[0-9][0-9][0-9][0-9])|((?!0000)[0-9][0-9][0-9][0-9](?!AS|CU|OO)([A-JL-VXZ][A-JL-VXZ]|AK|KA|KB|KC|KD|KE|KF))|((?!00[A-JL-VXZ][A-JL-VXZ]00)[0-9][0-9](?!AM|AN|AR|AP|CU|HO|ME|MG|MX|OO)[A-JL-VXZ][A-JL-VXZ][0-9][0-9])|(?!AA00AA)AA\d\d(AA|EE|II|OO|UU)|(?!AM|AP|CC|CD|([AEIOU][AEIOU]\d\d[A-Z][AEIOU]|[A-Z][AEIOU]\d\d[AEIOU][AEIOU])|(AN\d\dAL)|([B-DF-HJ-NP-TV-Z][AEIOU]\d\d[B-DF-HJ-NP-TV-Z][AEIOU]))([A-JL-VXZ][A-JL-VXZ][0-9][0-9][A-JL-VXZ][A-JL-VXZ])/
